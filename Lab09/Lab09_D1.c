...
#include  <msp430.h>
#include  <stdio.h>
// Temperature Sensor Calibration-30 C, see device datasheet for TLV table memory mapping
#define CALADC12_15V_30C  *((unsigned int *)0x1A1A)   
// Temperature Sensor Calibration-85 C, see device datasheet for TLV table memory mapping
...
void main(void)
{
    ...
    while(1)                    // Infinite loop
    {
        ...
        if ((ch == 'y') || (ch == 'Y')) // Character input validation
        {
            ADC12CTL0 &= ~ADC12SC;
